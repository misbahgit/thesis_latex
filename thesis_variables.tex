...
% \newcommand{\ttitle}{Your Thesis Title Here}
% \newcommand{\authornames}{Your Name Here}
% \newcommand{\supnameA}{Supervisor Name Here}
% \newcommand{\degreename}{Your Degree Name Here}
% \newcommand{\univname}{Your University Name Here}
% \newcommand{\deptname}{Your Department Name Here}
% \newcommand{\facname}{Your Faculty Name Here}
% \newcommand{\facnum}{Z-1165}
...
\newcommand{\supervisor}{Dr. John Doe}

% Define the co-supervisors (comma-separated list)
\newcommand{\cosupervisors}{Prof. Alice Smith, Dr. Bob Johnson, Dr. Carol Williams}
